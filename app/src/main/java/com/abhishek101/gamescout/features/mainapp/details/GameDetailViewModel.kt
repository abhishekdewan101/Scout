...
class GameDetailViewModelOld(
    private val gameRepository: GameRepository,
    private val libraryRepository: LibraryRepository,
) : ViewModel() {
    private lateinit var job: Job

    private var viewState by mutableStateOf<IgdbGameDetail?>(null)

    private var ownedPlatforms by mutableStateOf(mutableMapOf<String, Boolean>())

    private var inLibrary by mutableStateOf(false)

    private var initialSaveLocation by mutableStateOf("")

    private var initialOwnedStatus by mutableStateOf("")

    private var initialQueueStatus by mutableStateOf("")
